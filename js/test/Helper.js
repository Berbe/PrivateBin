...
/* TODO test fails since jsDOM version 17 - document.cookie remains empty
    ...
    describe('formatBytes', function () {
        ...
        jsc.property('formats kibibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1500) === '1.5 KiB';
        });

        jsc.property('formats mebibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(2 * 1000 * 1000) === '2 MiB';
        });

        jsc.property('formats gibibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(3.45 * 1000 * 1000 * 1000) === '3.45 GiB';
        });

        jsc.property('formats tebibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1.75 * 1000 ** 4) === '1.75 TiB';
        });

        jsc.property('formats pebibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1.5 * 1000 ** 5) === '1.5 PiB';
        });

        jsc.property('formats exbibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1.2345 * 1000 ** 6).startsWith('1.23 EiB');
        });

        jsc.property('formats zebibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1.23 * 1000 ** 7).startsWith('1.23 ZiB');
        });

        jsc.property('formats yobibytes correctly', function () {
            return $.PrivateBin.Helper.formatBytes(1.23 * 1000 ** 8).startsWith('1.23 YiB');
        });

        jsc.property('rounds to two decimal places', function () {
            return $.PrivateBin.Helper.formatBytes(1234567) === '1.23 MiB';
        });
    });
